                ...
                <Toolbar variant="dense" className={classes.toolbar}>
                    ...
                    <div display="block" justifyContent="center">
                        <Typography style={{color: 'black'}} variant="h5"
                                    component="h4"><strong>{`${props.userData.first_name} ${props.userData.last_name}`}</strong></Typography>
                        <Box className={classes.header_resp} display="flex" flexWrap justifyContent="flex-start" m={1}
                             p={1}>
